...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            @include('Element.delete_modal')
            @include('Element.deleteAll_modal')
            <div class="form-group text-ridght">
                ...
                <a href="{{ route('element.index') }}" class="btn bg-warning-light" data-toggle="tooltip"
                ...
                <a href="{{ route('element.create') }}" class="btn-nav btn btn-primary pull-right"><i
            ...
            <div class="card card-table">
                <div class="card-header bg-primary">
                    <h4 class="card-title text-center text-light"> Liste des Elements </h4>
                </div>
                <div class="card-body">
                    <div class="">
                            ...
                            <tbody>
                                @foreach ($elements as $element)
                                    <tr>
                                        ...
                                        <td data-id="{{ $element->id }}">#{{ $loop->index + 1 }}</td>
                                        <td>{{ $element->nom }}</td>
                                        <td>
                                            ...
                                            <a href="#" class="btn bg-danger-light btn-sm btn-delete"
                                                data-nom="{{ $element->nom }}" data-id="{{ $element->id }}"
