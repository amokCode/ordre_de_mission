...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            @include('Eleve.delete_modal')
            @include('Eleve.deleteAll_modal')
            <div class="form-group text-ridght">
                ...
                <a href="{{ route('eleve.index') }}" class="btn bg-warning-light" data-toggle="tooltip"
                ...
                <a href="{{ route('eleve.create') }}" class="btn-nav btn btn-primary pull-right"><i
            ...
            <div class="card card-table">
                <div class="card-header bg-primary">
                    <h4 class="card-title text-center text-light"> Liste des Eleve </h4>
                </div>
                <div class="card-body">
                    <div class="">
                            ...
                            <tbody>
                                @foreach ($eleves as $eleve)
                                    <tr>
                                        ...
                                        <td data-id="{{ $eleve->id }}">#{{ $loop->index + 1 }}</td>
                                        {{-- <td>{{ $car->nom }}</td> --}}
                                        							<td>{{ $eleve->nom }}</td>
							<td>{{ $eleve->prenom }}</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('eleve.edit', $eleve->id) }}"
                                            ...
                                            <a href="#" class="btn bg-danger-light btn-sm btn-delete"
                                                data-nom="{{ $eleve->nom }}" data-id="{{ $eleve->id }}"
